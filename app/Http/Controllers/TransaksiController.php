...
class TransaksiController extends Controller
{
  ...
  public function index(Request $request)
  {
    if (session("staff.type") !== "admin") {
      return redirect()
        ...
        ->with(
          "error",
          "Operator hanya dapat mencatat transaksi baru, tidak dapat melihat data transaksi.",
        );
    }
    ...
    $monthlyQuery = Transaksi::query()->whereBetween("tanggal_transaksi", [
      $startOfMonth,
      $endOfMonth,
    ]);

    $todayQuery = Transaksi::query()->whereBetween("tanggal_transaksi", [
      $startOfToday,
      $endOfToday,
    ]);
    ...
    $paymentMethodExpression =
      "COALESCE(NULLIF(metode_bayar, ''), 'Tidak dicatat')";
  ...
  public function store(Request $request)
  {
    ...
    return redirect()
      ...
      ->with(
        "success",
        "Transaksi berhasil disimpan. Operator dapat mencatat transaksi berikutnya.",
      );
  }
